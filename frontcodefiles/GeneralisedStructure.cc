...
int main(int arg , char** argv){
    //grid size , mass , EoS type , Tbound type , Pbound type , surface temp OR L, Psurf /opacity, "n" , # , boltzrel
    ...
    EoSvariables[0] = std::strtod(argv[10] , nullptr );
    EoSvariables[1] = std::strtod(argv[8] , nullptr );
    ...
    //s - Seagar(2007) (for perovskite) ; I - ideal gas , R = 8300
    ...
    int a;
        ...
        planet.mu_m = std::strtod(argv[10] , nullptr );
